...
<div id="answerdiv" onclick="answerdivsub()" style="width: 100%;min-height: 80px;border:1px;position: absolute;z-index: 2;top:30%;display: none;">
	...
	<div class="container">
		<div class="row title_class">
			<div class="col-xs-2"><a href="<?php echo U('task0101',array('testid'=>$testid,'userid'=>$userid,'kind'=>1,'username'=>$username,'realname'=>$realname));?>"><img src="/Public//img/reg_back.png" class="title_left_img"></a></div>
...
题行间距	<span class="caret"></span>
	...
	<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu2">
		...
		<div class="col-xs-4">
				...
				<div class="dropdown" id="dropdown0202">
	<a type="button" class="btn dropdown-toggle parent_button">
导出
	</a>
</div>
		</div>	
