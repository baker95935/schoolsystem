...
<div id="answerdiv" onclick="answerdivsub()" style="width: 100%;min-height: 80px;border:1px;position: absolute;z-index: 2;top:30%;display: none;">
	<img id="preanswerimg" style="display:none;width: 40px;height: 40px;margin-left: 100px;border: 1px solid #000000;"><img id="answerimg" style="width: 90%;margin-left: 5%;border: 1px solid #000000;" src="">
</div>
	<div class="container">
		<div class="row title_class">
			...
			<div class="col-xs-2"><a href="<?php echo U('home',array('userid'=>$userid,'username'=>$username,'realname'=>$realname));?>" style="color: white;">主页</a></div>
		</div>
	...
	<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu2">
		...
		<div class="col-xs-4">
					...
					<select class="blackselect" style="background-color: transparent;font-weight: normal;" onchange="window.location=this.value">
						<option value ="<?php echo U('managepaperdetail0202',array('testid'=>$testid,'userid'=>$userid,'paper_name'=>$paper_name,'username'=>$username,'realname'=>$realname,'testkind'=>$testkind));?>"> 导出</option>
						<option value="<?php echo U('phpmanagepaperdetailpdf',array('testid'=>$testid,'outkind'=>'D','paper_name'=>$paper_name,'testtime'=>$testtime,'testkind'=>$testkind));?>">习题pdf</option>
						<option value="<?php echo U('php_mykeymanagepaperanswerpdf',array('testid'=>$testid,'outkind'=>'D','paper_name'=>$paper_name,'testtime'=>$testtime,'testkind'=>$testkind));?>" >答案pdf</option>
					</select>
	<!--<a type="button" class="btn dropdown-toggle parent_button" href="<?php echo U('test_checkpage_downpdf',array('testid'=>$testid));?>">-->
<!--导出-->
	<!--</a>-->
