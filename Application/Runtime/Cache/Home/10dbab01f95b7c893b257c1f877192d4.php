...
<body class="background_color">
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 goal_font_middle"><p class="h3"><span>今天</span><span><?php echo ($count); ?></span><span>个新任务</span></p><p class="h5" >日期：<?php echo ($datemsg); ?></p><p class="h6">老师您辛苦了</p></div>
		</div>
		...
		<div class="row margin_middle" style="margin-top: 8%">
			...
			<div class="col-xs-4">
				...
				<tbody>
				<tr>
				<td> <a href="<?php echo U('/home/headteacher/managestuscore0401','userid='.$userid.'&username='.$username.'&realname='.$realname);?>"><img  src="/Public/img/page.png"></td>
				</tr>
				<tr>
				<td class="goal_font_middle">学生成绩</td>
				</tr>
				</tbody>
				</table>
		...
		<div class="row  margin_middle" style='margin-top:25px;' >
			<div class="col-xs-4">
				<table border="0" class="goal_middle">
					<tbody>
					<tr>
