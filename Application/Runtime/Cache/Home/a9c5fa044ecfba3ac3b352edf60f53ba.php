...
<div id="answerdiv" onclick="answerdivsub()" style="width: 100%;min-height: 80px;border:1px;position: absolute;z-index: 2;top:30%;display: none;">
	...
	<div class="container">
		<div class="row title_class">
			<div class="col-xs-2"><a href="<?php echo U('stu_keytestlist0403',array('userid'=>$userid,'username'=>$username,'realname'=>$realname));?>"><img src="/Public//img/reg_back.png" class="title_left_img"></a></div>
	...
	<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu2">
		...
		<div class="col-xs-4">
			<select class="blackselect" style="background-color: transparent;font-weight: normal;" onchange="window.location=this.value">
				<option value ="<?php echo U('managekeylistdetail0404',array('testid'=>$testid,'userid'=>$userid,'paper_name'=>$paper_name,'realname'=>$realname,'username'=>$username));?>"> 导出</option>
				<option value="<?php echo U('phpkey_managelistdownloadpdf',array('testid'=>$testid,'outkind'=>'D','paper_name'=>$paper_name,'testtime'=>$testtime,'keynote_msg'=>$keynote_msg));?>">习题pdf</option>
				<option value="<?php echo U('key_phpmanagelistdownloadanswerpdf',array('testid'=>$testid,'outkind'=>'D','paper_name'=>$paper_name,'testtime'=>$testtime,'keynote_msg'=>$keynote_msg));?>" >答案pdf</option>
			</select>
		</div>	
		</div>
		<div class="row">
