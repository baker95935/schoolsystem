...
<div id="imgpreviewdivid" style="background-color: #006dab;overflow-x: hidden;display: none;" >
	<div class="row" style="height: 60px;">
		...
		<div class="col-xs-3">
			<img id="img1" onclick="scalesub(this.id)" src="/Public/img/read_glass.png" style="margin-left:25%;margin-top:15px;width: 27px;height: 27px;">
			<img id="img0" onclick="scalesub(this.id)" src="/Public/img/shrink_mirror.png" style="margin-left:25%;margin-top:15px;width: 27px;height: 27px;display: none;">
		</div>
	</div>
	<div class="row">

		<div id="imgid" class="col-xs-12" style="overflow-y: auto;overflow-x: auto;">
			<img id="imgpreviewid" src="/Public/testpic/20180801.jpg" style="width: 100%;height: 100%;">
		</div>
	</div>
	<div class="row">
...
<div id="uploadid"  class="container">
	<div class="row">
		...
		<div class="col-xs-8 teacher_middle_01">
			<div id="teacher_middle_01_01" class="row">
				<div class="col-xs-6" style="text-align: left;"><a href="<?php echo U('setpage0101','userid='.$userid.'&username='.$username.'&realname='.$realname);?>"><img class="teacher_back_img" src="/Public/img/reg.png"></a></div>
			...
			<div class="col-xs-12" id="div_cover"  style="height:362px;position: relative;">
					<img id="test_img"  src="/Public/img/sample_01.png" class="teacher_paper_img">
				<div  name="ruleimg" id="rule_div" style="position: absolute;z-index: 2; width: 60%;height: 20px; background-color: #4c4c4c;top: 120px;right:40px;opacity:0.2;display: none;"></div>
					<img name="ruleimg" id="rule_img" onclick="mysub1()" style="position:absolute;z-index:2;top: 120px;right:20px;width:20px;height: 20px;display: none;" src="/Public/img/phone_b.png">
			</div>
			</div>
			<div class="row teacher_middle_01_03 mybootpadding" >
				<div class="col-xs-1"></div>
				<div class="col-xs-2"><img class="teacher_padding_top_big" id="leftbutton" style="width: 16px;height: 24px;" src="/Public/img/phone01.png"></div>
				<div class="col-xs-1" ><div id="num_div" class="teacher_padding_top_font">0</div></div>
				<div class="col-xs-2"><img class="teacher_padding_top_big"  id="rightbutton" style="width: 16px;height: 24px;"  src="/Public/img/phone02.png"></div>
				<div class="col-xs-1"></div>
				<div class="col-xs-2"></div>
				<div class="col-xs-2"><img class="teacher_padding_top_small"  style="display:block;" id="rulebuttona" src="/Public/img/phone03a.png"><img class="teacher_padding_top_small"  style="display:none;" id="rulebuttonb" src="/Public/img/phone03b.png"></div>
				<div class="col-xs-1"></div>
			</div>
			<div  class="row teacher_middle_01_03 mybootpadding">
				...
				<form name="tform" id="tform">
					...
					<input name="papername" value="<?php echo ($testdata['papername']); ?>" type="hidden">
					<input name="arraymsg" value="<?php echo ($testdata['arraymsg']); ?>" type="hidden">
					<input name="paperkind" value="<?php echo ($testdata['paperkind']); ?>" type="hidden">
					<input name="gradeid" value="<?php echo ($testdata['gradeid']); ?>" type="hidden">
					<input name="publishname" value="<?php echo ($testdata['publishname']); ?>" type="hidden">
					<input name="publishtime" value="<?php echo ($testdata['publishtime']); ?>" type="hidden">
			...
			<div class="row teacher_middle_01_03_checked mybootpadding" >
				...
				<form name="aform" id="aform">
					...
					<input name="gradeid" value="<?php echo ($testdata['gradeid']); ?>" type="hidden">
					<input name="chapterid" value="<?php echo ($testdata['chapterid']); ?>" type="hidden">
					<input name="publishname" value="<?php echo ($testdata['publishname']); ?>" type="hidden">
					<input name="publishtime" value="<?php echo ($testdata['publishtime']); ?>" type="hidden">
			...
			<div  class="row teacher_middle_01_03 mybootpadding">
				<div class="col-xs-1"></div>
				<div class="col-xs-2"><img onclick="backsub()"  class="teacher_padding_top_small"  src="/Public/img/phone31.png"></div>
				<div class="col-xs-2" style="padding-top: 15px;"><span id="justnum">0</span></div>
				<div class="col-xs-2"><img onclick="upsub()"  class="teacher_padding_top_small"  src="/Public/img/phone32.png"></div>
				...
				<div class="col-xs-2"><img onclick="deletesub()"class="teacher_padding_top_small"  src="/Public/img/phone34.png"></div>
				<div class="col-xs-1"></div>
			</div>
			<div  class="row teacher_middle_01_03 mybootpadding">
				<div class="col-xs-1"></div>
	...
	<div class="row teacher_bottom">
		<div class="col-xs-2"><a href="<?php echo U('setpage0101','userid='.$userid.'&username='.$username.'&realname='.$realname);?>"><img class="img-responsive center-block teacher_bottom_arrow" src="/Public/img/reg.png"></a></div>
...
<input id="userdata" type="hidden" value="<?php echo ($userdata); ?>">
<input id="testdata" type="hidden" value="<?php echo ($testdata); ?>">
...
<input id="gradeid" name="gradeid" type="hidden" value="<?php echo ($testdata['gradeid']); ?>">
	...
	function deletesub()
	{
		...
		if(ele.indexOf('test')>-1)
		{
			...
			if(sum==2)
			{
				...
				$("#tupload1").val("");
				$("#test_img").attr('src',"/Public/img/sample_01.png");
				$("#test_sum").val(1);
				fontintcss("test");
...
function tsubmit(){
  ...
  //return;
	...
	$.ajax({
		url: "<?php echo U('Headteacher/tupload');?>",
		type: 'POST',
		data: formData,
		dataType: 'text',
		cache: false,
...
function asubmit(){
	...
	$.ajax({
		url: "<?php echo U('Headteacher/aupload');?>",
		type: 'POST',
		data: formData,
		dataType: 'text',
		cache: false,
