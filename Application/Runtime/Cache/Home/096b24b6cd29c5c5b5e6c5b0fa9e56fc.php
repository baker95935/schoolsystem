...
<body class="background_color">
	<div class="container" style="height: 100%;">
		...
		<div class="col-xs-3" >
			...
			<?php if(is_array($subjectList)): foreach($subjectList as $key=>$item): ?><option value ="<?php echo ($item["id"]); ?>"><?php echo ($item["subjectmsg"]); ?></option><?php endforeach; endif; ?>
			</select>
		...
		<div class="col-xs-3">
			...
			<div class="col-xs-3">
				<select name="operation" id="operation" class="blackselect">
...
<script>
	...
	function managetestdata(userid,nowpage,pagelength,subject='',classinfo='',group='')
	{
		$.ajax({
			url:"<?php echo U('phptestmsg0201');?>",
			data:{userid:userid,nowpage:nowpage,pagelength:pagelength,subject:subject,classinfo:classinfo,group:group},
			datatype:'json',
			type:'post',
			success:function(re){
	...
	function selectinfo()
    {
		...
		var userid=$('#userid').val();
		$('#list1').html('');
		managetestdata(userid,nowpage,pagelength,subject,classinfo,group);
    }
</script>
</html>