...
<div class="contain" style="width: 100%">
    ...
    <div class="row">
        <div class="col-xs-6" style="height: 330px;border-right:1px solid #C3C3C3;">
            <div class="row sysset_blue" style="clear: left;"><span style="font-size: 16px;margin-left: 8%;"><b>1.学校统计</b></span><span style="margin-left: 62%"></span><a id="school_ok" onclick="newschooldata('school')" style="display: none" href="javascript:void(0)">Add</a><span>&nbsp;&nbsp;&nbsp;&nbsp;</span><a id="school_a" onclick="div_list_sub('New')" href="javascript:void(0)">New</a></div>
            <hr style="margin-left: 6%;">
            <div class="row" style="height: 250px; overflow-y: auto;padding-left: 8%;padding-right: 2%">

                <table id="table_school" class="sysset_msgtable" style="width: 100%;">
                </table>
                ...
                <div class="sysset_msgli" id="school_msgli"  style="display: none;">
                    <ol>
                        <li >
                           <span >学校名称：</span> <input id="schoolname"   type="text">
                        </li>
                        <li >
                            <span class="sysset_marginleft28">类型：</span>
                            <select id="levelmsg">
                        ...
                        <li>
                             <span class="sysset_marginleft14" >联系人：</span>   <input id="linkman"  required="required"  type="text">
                        </li>
                        <li>
                            <span  class="sysset_marginleft28" >电话：</span>  <input id="phone"   required="required"   type="text" value="">
                        </li>
                        <li>
                        ...
                        <li >
                            <span >班级数量/年级：</span> <input id="classcount"  required="required"  type="text" value="">
                        </li>
...
//        return;
    ...
    function newschooldata(kind)
    {
        ...
        $.ajax({
            url: "<?php echo U('php_newschool_data_sql');?>",
            type: 'POST',
