...
<body class="background_color">
	...
	<div class="container" style="height: 100%;">
		<div class="row title_class">
			...
			<div class="col-xs-2"><a href="<?php echo U('testmsg0203',array('userid'=>$userid,'paper_name'=>$paper_name,'classid'=>$classid,'testid'=>$testid));?>" style="color: white;font-size: 15px;display: block;margin-top: 1px;">习题</a></div>
		</div>
